package it.polito.bigdata.lab10.ex02;
...
public class RelevantHashtagAnalysis {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        SparkConf conf = new SparkConf().setAppName("Lab 10.2 - Relevant hashtag analysis with Spark Streaming");
        ...
        // Count number of hashtags and filter relevant
        JavaPairDStream<String, Integer> relevantHashtagsCountStream = hashtagsStream
            .mapToPair(h -> new Tuple2<>(h, 1))
            .reduceByKey((v1, v2) -> v1 + v2)
            .filter(p -> p._2() >= THRESHOLD);
        
        // Sort hashtags by occurrances
        JavaPairDStream<Integer, String> sortedHashtagsCountStream = relevantHashtagsCountStream
